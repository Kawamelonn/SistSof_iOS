...
class ActividadesViewController: UIViewController{
    ...
    @IBOutlet weak var MiVistaAuto2: UIView!
        
    @IBOutlet weak var MiVistaAutoMala2: UIView!
        
    @IBOutlet weak var MiVistaAutoBloqueada2: UIView!
    ...
    override func viewWillAppear(_ animated: Bool) {
        ...
        func updateUI(with actividades:Actividades, autodiagnosticos:Autodiagnosticos, autodiagnosticos2:Autodiagnosticos){
            ...
            var hayAuto = engine.nextAuto()
            let completadoAuto2 = engine.getAutoStatus()
            hayAuto = engine.nextAuto()
            ...
            hay = self.engine.nextQuestion()
                    ...
                    DispatchQueue.main.async {
                        ...
                        if completadoAuto1 == false{
                            ...
                            self.MiVistaBloqueada1.isHidden = true
                            self.MiVistaMala1.isHidden = false
                            if completado1{
                        ...
                        if completado6 == false{
                            self.MiVistaAuto2.isHidden = true
                            self.MiVistaAutoMala2.isHidden = true
                            self.MiVistaAutoBloqueada2.isHidden = false
                            
                        }else {
                            self.MiVistaAutoBloqueada2.isHidden = true
                            self.MiVistaAutoMala2.isHidden = false
                            print("Actividad 6 completada")
                            //var textovv = "falsa"
                            let idd = self.engine.getID()
                            if completadoAuto2 {
                                //textovv = "completada"
                                self.MiVistaAuto2.isHidden = false
                                self.MiVistaAutoMala2.isHidden = true
                                print("auto2 ?: \(idd)")
                            }
                            //self.textoA2.text = textovv
